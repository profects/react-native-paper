...
(() => {
  class TouchableRipple extends React.Component {
    constructor() {
      ...
      this.handlePressIn = e => {
        ...
        if (centered) {
          ...
          const startX = e.nativeEvent.touches ? e.nativeEvent.touches[0].pageX : e.pageX;
          const startY = e.nativeEvent.touches ? e.nativeEvent.touches[0].pageY : e.pageY;
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement(TouchableWithoutFeedback, Object.assign({}, rest, {
...
//# sourceMappingURL=index.js.maps({}, rest, {
      onPressIn: this.handlePressIn,
      onPressOut: this.handlePressOut,
      disabled: disabled
    }), /*#__PURE__*/React.createElement(View, {
