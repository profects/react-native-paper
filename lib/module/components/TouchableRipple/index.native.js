  ...
  class TouchableRipple extends React.Component {
    render() {
      ...
      if (TouchableRipple.supported) {
        return /*#__PURE__*/React.createElement(TouchableNativeFeedback, Object.assign({}, rest, {
          disabled: disabled,
      ...
      return /*#__PURE__*/React.createElement(TouchableHighlight, Object.assign({}, rest, {
        disabled: disabled,
        style: [borderless && {
          overflow: 'hidden'
        }, style],
...
//# sourceMappingURL=index.native.js.maplor : color(calculatedRippleColor).fade(0.5).rgb().string()
    }), React.Children.only(children));
  }
