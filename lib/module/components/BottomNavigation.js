...
const Touchable = (_ref) => {
  ...
  return TouchableRipple.supported ? /*#__PURE__*/React.createElement(TouchableRipple, Object.assign({}, rest, {
    borderless: borderless,
    centered: centered,
    rippleColor: rippleColor,
    style: style
  }), children) : /*#__PURE__*/React.createElement(TouchableWithoutFeedback, Object.assign({}, rest), /*#__PURE__*/React.createElement(View, {
    style: style
  }, children));
};
...
(() => {
  class BottomNavigation extends React.Component {
    constructor(props) {
      ...
      this.isShifting = () => typeof this.props.shifting === 'boolean' ? this.props.shifting : this.props.navigationState.routes.length > 3;
    ...
    render() {
      const {
        ...
        renderIcon,
        renderLabel,
        renderTouchable = props => /*#__PURE__*/React.createElement(Touchable, Object.assign({}, props)),
        getLabelText = ({
          route
        }) => route.title,
        getBadge = ({
